...
const FOODS = [
  ...
  // DAIRY
  { id:'whole_milk', name:'Whole Milk', cal:61, p:3.2, f:3.3, c:4.8, serving:240, unit:'ml', cat:'dairy', sizes:[{label:'Small',mult:0.6},{label:'Medium',mult:1},{label:'Large',mult:1.5}] },
  { id:'skim_milk', name:'Skim Milk', cal:35, p:3.4, f:0.1, c:5, serving:240, unit:'ml', cat:'dairy', sizes:[{label:'Small',mult:0.6},{label:'Medium',mult:1},{label:'Large',mult:1.5}] },
  ...
  // GRAINS
  { id:'white_rice', name:'White Rice (cooked)', cal:130, p:2.7, f:0.3, c:28, serving:100, unit:'g', cat:'grain', sizes:[{label:'Small',mult:1.5},{label:'Medium',mult:2.5},{label:'Large',mult:4}] },
  { id:'brown_rice', name:'Brown Rice (cooked)', cal:123, p:2.7, f:1, c:26, serving:100, unit:'g', cat:'grain', sizes:[{label:'Small',mult:1.5},{label:'Medium',mult:2.5},{label:'Large',mult:4}] },
  { id:'oats', name:'Oats (dry)', cal:389, p:17, f:7, c:66, serving:80, unit:'g', cat:'grain', sizes:[{label:'Small',mult:0.75},{label:'Medium',mult:1},{label:'Large',mult:1.5}] },
  ...
  { id:'biryani', name:'Chicken Biryani', cal:170, p:9, f:6, c:21, serving:100, unit:'g', cat:'pakistani', sizes:[{label:'Small',mult:2},{label:'Medium',mult:3.5},{label:'Large',mult:5}] },
  { id:'beef_biryani', name:'Beef Biryani', cal:185, p:10, f:8, c:21, serving:100, unit:'g', cat:'pakistani', sizes:[{label:'Small',mult:2},{label:'Medium',mult:3.5},{label:'Large',mult:5}] },
  { id:'dal', name:'Dal (lentil curry)', cal:116, p:7, f:2, c:18, serving:100, unit:'g', cat:'pakistani', sizes:[{label:'Small',mult:1.5},{label:'Medium',mult:2.5},{label:'Large',mult:4}] },
  { id:'chicken_karahi', name:'Chicken Karahi', cal:165, p:18, f:8, c:4, serving:100, unit:'g', cat:'pakistani', sizes:[{label:'Small',mult:1.5},{label:'Medium',mult:2.5},{label:'Large',mult:4}] },
  { id:'haleem', name:'Haleem', cal:180, p:14, f:8, c:14, serving:100, unit:'g', cat:'pakistani', sizes:[{label:'Small',mult:1.5},{label:'Medium',mult:2.5},{label:'Large',mult:4}] },
  { id:'saag', name:'Saag (spinach / mustard)', cal:70, p:4, f:3, c:8, serving:100, unit:'g', cat:'pakistani', sizes:[{label:'Small',mult:1.5},{label:'Medium',mult:2.5},{label:'Large',mult:4}] },
  { id:'aloo_sabzi', name:'Aloo Sabzi (potato curry)', cal:130, p:3, f:5, c:20, serving:100, unit:'g', cat:'pakistani', sizes:[{label:'Small',mult:1.5},{label:'Medium',mult:2.5},{label:'Large',mult:4}] },
  { id:'samosa', name:'Samosa (1 piece)', cal:130, p:3, f:7, c:15, serving:50, unit:'g', cat:'pakistani' },
  { id:'chai', name:'Chai (milk + sugar)', cal:60, p:2, f:2, c:9, serving:240, unit:'ml', cat:'pakistani', sizes:[{label:'Small',mult:0.6},{label:'Medium',mult:1},{label:'Large',mult:1.5}] },
  { id:'lassi', name:'Lassi (sweet)', cal:180, p:6, f:6, c:26, serving:250, unit:'ml', cat:'pakistani', sizes:[{label:'Small',mult:0.6},{label:'Medium',mult:1},{label:'Large',mult:1.5}] },
  { id:'dahi', name:'Dahi (plain yogurt)', cal:61, p:3.5, f:3.3, c:4.7, serving:100, unit:'g', cat:'pakistani' },
  { id:'nihari', name:'Nihari', cal:180, p:16, f:11, c:4, serving:100, unit:'g', cat:'pakistani', sizes:[{label:'Small',mult:1.5},{label:'Medium',mult:2.5},{label:'Large',mult:4}] },
  ...
  { id:'chana', name:'Chana (chickpea curry)', cal:164, p:8.9, f:2.6, c:27, serving:100, unit:'g', cat:'pakistani', sizes:[{label:'Small',mult:1.5},{label:'Medium',mult:2.5},{label:'Large',mult:4}] },
  { id:'qeema', name:'Qeema (minced meat curry)', cal:220, p:18, f:14, c:5, serving:100, unit:'g', cat:'pakistani', sizes:[{label:'Small',mult:1.5},{label:'Medium',mult:2.5},{label:'Large',mult:4}] },
  { id:'aloo_gosht', name:'Aloo Gosht', cal:175, p:12, f:9, c:12, serving:100, unit:'g', cat:'pakistani', sizes:[{label:'Small',mult:1.5},{label:'Medium',mult:2.5},{label:'Large',mult:4}] },
  { id:'palak_gosht', name:'Palak Gosht', cal:160, p:14, f:9, c:5, serving:100, unit:'g', cat:'pakistani', sizes:[{label:'Small',mult:1.5},{label:'Medium',mult:2.5},{label:'Large',mult:4}] },
  { id:'korma', name:'Chicken Korma', cal:210, p:16, f:14, c:6, serving:100, unit:'g', cat:'pakistani', sizes:[{label:'Small',mult:1.5},{label:'Medium',mult:2.5},{label:'Large',mult:4}] },
  { id:'mutton_karahi', name:'Mutton Karahi', cal:230, p:20, f:15, c:3, serving:100, unit:'g', cat:'pakistani', sizes:[{label:'Small',mult:1.5},{label:'Medium',mult:2.5},{label:'Large',mult:4}] },
  { id:'tarka_dal', name:'Tarka Dal', cal:130, p:8, f:5, c:15, serving:100, unit:'g', cat:'pakistani', sizes:[{label:'Small',mult:1.5},{label:'Medium',mult:2.5},{label:'Large',mult:4}] },
  { id:'chaat', name:'Chaat / Dahi Phulki', cal:180, p:5, f:4, c:32, serving:150, unit:'g', cat:'pakistani', sizes:[{label:'Small',mult:0.7},{label:'Medium',mult:1},{label:'Large',mult:1.5}] },
  { id:'gulab_jamun', name:'Gulab Jamun (1 piece)', cal:150, p:2, f:6, c:23, serving:50, unit:'g', cat:'pakistani' },
  { id:'kheer', name:'Kheer (rice pudding)', cal:150, p:4, f:5, c:23, serving:100, unit:'g', cat:'pakistani', sizes:[{label:'Small',mult:1},{label:'Medium',mult:1.5},{label:'Large',mult:2.5}] },
  { id:'sheer_khurma', name:'Sheer Khurma', cal:200, p:5, f:8, c:28, serving:100, unit:'g', cat:'pakistani', sizes:[{label:'Small',mult:1},{label:'Medium',mult:1.5},{label:'Large',mult:2.5}] },
  { id:'rooh_afza', name:'Rooh Afza (glass with milk)', cal:180, p:4, f:4, c:32, serving:250, unit:'ml', cat:'pakistani', sizes:[{label:'Small',mult:0.6},{label:'Medium',mult:1},{label:'Large',mult:1.5}] },
  { id:'kulfi', name:'Kulfi (1 stick)', cal:180, p:4, f:8, c:24, serving:80, unit:'g', cat:'pakistani' },
  { id:'gajar_halwa', name:'Gajar Ka Halwa', cal:210, p:3, f:9, c:30, serving:100, unit:'g', cat:'pakistani', sizes:[{label:'Small',mult:1},{label:'Medium',mult:1.5},{label:'Large',mult:2.5}] },
  // VEGETABLES
  ...
  { id:'ridge_gourd', name:'Ridge Gourd / Turai', cal:20, p:0.5, f:0.1, c:4.3, serving:100, unit:'g', cat:'vegetable' },
  { id:'bottle_gourd', name:'Bottle Gourd / Lauki / Doodhi', cal:14, p:0.6, f:0.02, c:3.4, serving:100, unit:'g', cat:'vegetable' },
  { id:'bitter_gourd', name:'Bitter Gourd / Karela', cal:17, p:1, f:0.2, c:3.7, serving:100, unit:'g', cat:'vegetable' },
  { id:'okra', name:'Okra / Bhindi', cal:33, p:1.9, f:0.2, c:7.5, serving:100, unit:'g', cat:'vegetable' },
  { id:'eggplant', name:'Eggplant / Baingan', cal:25, p:1, f:0.2, c:5.9, serving:100, unit:'g', cat:'vegetable' },
  { id:'pumpkin', name:'Pumpkin / Kaddu', cal:26, p:1, f:0.1, c:6.5, serving:100, unit:'g', cat:'vegetable' },
  { id:'peas', name:'Green Peas / Matar', cal:81, p:5.4, f:0.4, c:14.5, serving:100, unit:'g', cat:'vegetable' },
  { id:'taro', name:'Taro / Arvi (boiled)', cal:112, p:1.5, f:0.2, c:26, serving:100, unit:'g', cat:'vegetable' },
  { id:'fenugreek', name:'Fenugreek Leaves / Methi', cal:49, p:4.4, f:0.9, c:6, serving:100, unit:'g', cat:'vegetable' },
  { id:'green_beans', name:'Green Beans / Phaliyan', cal:31, p:1.8, f:0.1, c:7, serving:100, unit:'g', cat:'vegetable' },
  { id:'zucchini', name:'Zucchini / Courgette', cal:17, p:1.2, f:0.3, c:3.1, serving:100, unit:'g', cat:'vegetable' },
  { id:'corn', name:'Sweet Corn (boiled)', cal:96, p:3.4, f:1.5, c:21, serving:100, unit:'g', cat:'vegetable' },
  { id:'cabbage', name:'Cabbage', cal:25, p:1.3, f:0.1, c:5.8, serving:100, unit:'g', cat:'vegetable' },
  { id:'turnip', name:'Turnip / Shalgam', cal:28, p:0.9, f:0.1, c:6.4, serving:100, unit:'g', cat:'vegetable' },
  { id:'radish', name:'Radish / Mooli', cal:16, p:0.7, f:0.1, c:3.4, serving:100, unit:'g', cat:'vegetable' },
  // FRUITS
  ...
  { id:'pomegranate', name:'Pomegranate / Anar', cal:83, p:1.7, f:1.2, c:19, serving:100, unit:'g', cat:'fruit' },
  { id:'guava', name:'Guava / Amrood', cal:68, p:2.6, f:1, c:14, serving:100, unit:'g', cat:'fruit' },
  { id:'papaya', name:'Papaya / Papita', cal:43, p:0.5, f:0.3, c:11, serving:100, unit:'g', cat:'fruit' },
  { id:'lychee', name:'Lychee / Litchi', cal:66, p:0.8, f:0.4, c:17, serving:100, unit:'g', cat:'fruit' },
  { id:'peach', name:'Peach / Aaru', cal:39, p:0.9, f:0.3, c:10, serving:100, unit:'g', cat:'fruit' },
  { id:'pear', name:'Pear / Nashpati', cal:57, p:0.4, f:0.1, c:15, serving:100, unit:'g', cat:'fruit' },
  { id:'chikoo', name:'Chikoo / Sapodilla', cal:83, p:0.4, f:1.1, c:20, serving:100, unit:'g', cat:'fruit' },
  { id:'jamun', name:'Jamun / Black Plum', cal:62, p:0.7, f:0.2, c:14, serving:100, unit:'g', cat:'fruit' },
  // NUTS
  ...
  { id:'pizza_slice', name:'Pizza Cheese (1 slice)', cal:285, p:12, f:10, c:36, serving:107, unit:'g', cat:'fastfood', sizes:[{label:'Small',mult:0.7},{label:'Medium',mult:1},{label:'Large',mult:1.4}] },
  { id:'fries', name:'French Fries', cal:365, p:4, f:17, c:48, serving:117, unit:'g', cat:'fastfood', sizes:[{label:'Small',mult:0.7},{label:'Medium',mult:1},{label:'Large',mult:1.5}] },
  { id:'shawarma', name:'Chicken Shawarma', cal:320, p:22, f:12, c:32, serving:150, unit:'g', cat:'fastfood', sizes:[{label:'Small',mult:0.8},{label:'Medium',mult:1},{label:'Large',mult:1.4}] },
  { id:'burger', name:'Beef Burger', cal:354, p:20, f:17, c:29, serving:150, unit:'g', cat:'fastfood', sizes:[{label:'Small',mult:0.7},{label:'Medium',mult:1},{label:'Large',mult:1.4}] },
  // SNACKS
  ...
  // DRINKS
  { id:'cola', name:'Cola / Pepsi', cal:140, p:0, f:0, c:39, serving:355, unit:'ml', cat:'drink', sizes:[{label:'Small',mult:0.6},{label:'Medium',mult:1},{label:'Large',mult:1.7}] },
  { id:'oj', name:'Orange Juice', cal:110, p:1.7, f:0.5, c:26, serving:240, unit:'ml', cat:'drink', sizes:[{label:'Small',mult:0.6},{label:'Medium',mult:1},{label:'Large',mult:1.5}] },
  { id:'black_coffee', name:'Black Coffee', cal:2, p:0.3, f:0, c:0, serving:240, unit:'ml', cat:'drink', sizes:[{label:'Small',mult:0.6},{label:'Medium',mult:1},{label:'Large',mult:1.5}] },
  { id:'energy_drink', name:'Energy Drink', cal:110, p:1, f:0.5, c:28, serving:250, unit:'ml', cat:'drink', sizes:[{label:'Small (250ml)',mult:1},{label:'Large (500ml)',mult:2}] },
  { id:'protein_shake', name:'Protein Shake (with water)', cal:120, p:24, f:2, c:3, serving:330, unit:'ml', cat:'drink', sizes:[{label:'Small',mult:0.75},{label:'Medium',mult:1},{label:'Large',mult:1.5}] },
  { id:'coconut_water', name:'Coconut Water', cal:45, p:1.7, f:0.5, c:9, serving:240, unit:'ml', cat:'drink', sizes:[{label:'Small',mult:0.6},{label:'Medium',mult:1},{label:'Large',mult:1.5}] },
];
